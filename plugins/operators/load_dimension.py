...
class LoadDimensionOperator(BaseOperator):
    """
        ...
        :type table: str
        :param table_insert_query - query to insert records into the table
        :type table_insert_query: str
    ...
    @apply_defaults
    def __init__(self, table: str, table_insert_query: str, redshift_conn_id: str, load_mode: str, *args, **kwargs):
        super(LoadDimensionOperator, self).__init__(*args, **kwargs)
        self.table_insert_query = table_insert_query
        self.table = table
    ...
    def execute(self, context):
        ...
        redshift_hook.run(self.table_insert_query, autocommit=True)
        for output in redshift_hook.conn.notices:
            self.log.info(output)
